...
SECRET_KEY = 'django-insecure-z=89lu@jwsrtf=sba48qcg26vm-#pp1&6e30pib7^s#sd*!_rz'
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'IRIS API',
    'DESCRIPTION': 'IRIS is a Really Intelligent System',
    'VERSION': '1.0.0',
    # Other settings
}
...
SCHEMA_FILE_PATHS = ['./openapi_schema',
                     '../iris-frontend/src/services/api/api']
